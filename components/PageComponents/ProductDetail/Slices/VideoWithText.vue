  ...
  <v-container>
    <v-row>
      <v-col cols="12" md="12" class="text-center">
        <prismic-rich-text :field="slice.primary.video_title" />
        <prismic-rich-text :field="slice.primary.video_text" />
      </v-col>
      <v-col cols="12" md="12">
        <v-responsive style="max-height: 70vh; max-width: 124.5vh" class="mx-auto" :aspect-ratio="16/9">
          <iframe
            width="100%"
            height="100%"
...
export default class VideoWithText extends Vue {}
</script>
